...
-- Original 0005 (20260509000001_studio_workspace_chat_messages.sql) created the
-- column without an FK, which leaves chat rows orphaned when a user is deleted.
-- This is inconsistent with the cascade pattern used by studio_workspaces.user_id.
--
