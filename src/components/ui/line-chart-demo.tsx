/**
 * Demo for the shadcn line-chart component.
 * Imports point at @/components/ui/* (Studio convention).
 *
 * Usage example — drop the component anywhere:
 *   import GlowingLineChart from '@/components/ui/line-chart-demo';
 *   ...
 *   <GlowingLineChart />
 */
"use client";
